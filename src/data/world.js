...
const mapCountryToAlias = (region) => COUNTRY_ALIAS[region] || region;

WORLD_MAP.objects.ne_110m_admin_0_countries.geometries.forEach(country => {
  ...
  // Add series for europe only
  // if (EUROPEAN_COUNTRIES.indexOf(properties.NAME) > -1) {
  //   const countrySeriesData = series.filter(item => mapCountryToAlias(item['Country/Region']) === properties.NAME);
  //   properties.series = sumSeries(countrySeriesData);
  // }
});
